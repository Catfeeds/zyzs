...
window.onload = function() {
	if (window.applicationCache) {
		...
		$('body').append("<div style='width:100%;background-color:#000;height:100%;position:fixed;top:0;left:0;'><div style='padding-top:150px;line-height:50px;color:#fff;font-size:24px;text-align:center;'><div style='padding-bottom:50px;'>您的浏览器版本太低，请使用支持html5的浏览，否则会影响部分功能。</div><div><div style='padding-bottom:50px;'>推荐浏览器：</div><a class='button button-large border-white icon-cloud-download' style='width:400px; margin:0 auto; display:block;' href='http://www.firefox.com.cn/'> 下载火狐浏览器</a></li></ul></div></div></div>");		
	}
}
$(function(){
	$(".manage-header>ul>li").hover(function(){
		$(this).find('ul').show();
	},function(){
		$(this).find('ul').hide();
	})
