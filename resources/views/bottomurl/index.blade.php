  ...
  <div class="padding-large">
    ...
    <div class="line-big margin-large-bottom">
      ...
      <div class="x6 text-right">
        ...
        <a href="/manage/bottomurl/create" class="button icon-file-o bg-yellow margin-right"> 新增</a>
    ...
    <div class="x12">
      ...
      <span class="icon-thumb-tack"> </span>页脚链接</h1>
      ...
      <div class="table-responsive padding-large-bottom articletable">
            <table class="table table-striped table-bordered">
                ...
                @foreach ($bottomurl as $key=>$value)
                <tr>
                <td align="center">
                ...
                <td align="center"><a href="/manage/bottomurl/remove/{{ $value->id }}" class="button button-little bg-main icon-trash-o" onclick="{if(confirm('删除后不可恢复：')){return true;}return false;}"> 删除</a></td>
