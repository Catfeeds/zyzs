...
<div class="container bg-white margin-large-top">
	<div class="padding-large">
		<form method="POST" action="/manage/sitenav/sub/insert/{{$parentnav->id}}">
		...
		<div class="x12">
			...
			<div class="form-group detailsedit @if(count(old('type'))>0 && old('showdetails')=="0") hide @endif">
