	...
	<form method="POST" >
		...
		<div class="x12">
			<div class="form-group padding-large-bottom">
				...
				<h1><span class="icon-edit"> </span>正在为 “<span class="text-main">{{ $navigation->name }}</span>” 增加案例</h1>
				</div>
			</div>
		</div>
		...
		<div class="line-big">
			...
			<div class="x6">
				<div class="form-group padding-large-bottom">
				    ...
				    <div class="field"><input type="text" class="input" id="title" name="title" data-validate="required:必填" value="{{ old('title') }}" placeholder="案例标题" /></div>
				...
				<div class="form-group padding-large-bottom">
				    ...
				    <div class="field"><input type="number" class="input" id="order" name="order" data-validate="required:必填,number:只能是数字,compare#>0:值不得小于1,compare#<99999999999:值不得大于99999999999,length#>=1:长度不能小于1个字符,length#<=11:长度不得大于11个字符" value="1500" placeholder="排序" /></div>
				...
				<div class="form-group padding-large-bottom">
					...
					<div class="field">
						<input type="text" name="subtitle" class="input input-small">
					</div>
				</div>
				...
				<div class="form-group padding-large-bottom">
					...
					<div class="field">
						<input class="input" name="huxing"></input>
					</div>
				...
				<div class="form-group padding-large-bottom">
					...
					<div class="field">
						<input type="text" name="mianji" value="" class="input">
					</div>
				...
				<!-- <div class="form-group padding-large-bottom">
					...
					<div class="field">
						<input type="text" name="fengge" value="" class="input">
					</div>
				...
				<div class="form-group padding-large-bottom">
					...
					<div class="field">
						<input type="text" name="leixing" value="" class="input">
					</div>
			...
			<div class="x4 x2-move">
				<div class="form-group padding-large-bottom">
				    ...
				    <div class="field"><input type="text" class="input" id="photo" name="photo" data-validate="required:必填" value="{{ old('photo') }}" placeholder="" onclick="BrowseServer( 'Images:/', 'photo' );" /></div>
				    <div class="text-gray text-small"></div>
				...
				<div class="form-group padding-large-bottom">
					...
					<div class="button-group border-yellow radio">
					    <label class="button @if(count(old('indexshow'))<=0 || old('indexshow')=="0")active @endif">
					        <input name="indexshow" value="0" @if(count(old('indexshow'))<=0 || old('indexshow')=="0")checked="checked" @endif type="radio"> 不显示
					    </label>
					    <label class="button @if(old('indexshow')=="1")active @endif">
					        <input name="indexshow" value="1" @if(old('indexshow')=="1")checked="checked" @endif type="radio"> 显示
					    </label>
					</div>
				...
				<div class="form-group padding-large-bottom">
					...
					<div class="field"><input type="text" class="input" id="keywords" name="keywords" data-validate="required:必填,keywords:错误：只能为中文、英文、数字，用英文小写逗号隔开,length#<=400:长度必须小于100个字符" placeholder="关键词1,关键词2,关键词3" value="{{ old('keywords') }}" /></div>
			...
			<div class="x12">
				<div class="form-group padding-large-bottom">
					...
					<div class="field">
						<textarea id="editor1" class="input" name="details"></textarea>
					</div>
				</div>
			</div>
