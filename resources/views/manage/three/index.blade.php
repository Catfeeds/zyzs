  ...
  <div class="padding-large">
    ...
    <div class="line-big margin-large-bottom">
      ...
      <div class="x6 text-right">
        ...
        <a href="/manage/three/create" class="button icon-file-o bg-yellow margin-right"> 新增</a>
    ...
    <div class="x12">
      ...
      <span class="icon-thumb-tack"> </span>首页三块图文</h1>
      ...
      <div class="table-responsive padding-large-bottom articletable">
            <table class="table table-striped table-bordered">
                <tr>
                  ...
                  <td align="center" width="180">标题</td>
                  <td align="center" width="180">图片</td>
                  <td align="center" width="180">图片标题</td>
                  <td align="center" width="180">链接</td>
                ...
                <td>
                  <input type="text" name="mtitle[]" class="input input-small" value="{{$value->mtitle}}">
                </td>
                <td>
                ...
                <td align="center">
                  <input type="text" name="content[]" class="input input-small" value="{{$value->content}}">
                </td>
                <td align="center"><a href="/manage/three/{{ $value->id }}/delete" class="button button-little bg-main icon-trash-o" onclick="{if(confirm('删除后不可恢复：')){return true;}return false;}"> 删除</a></td>
