  ...
  <div class="padding-large">
    ...
    <div class="line-big margin-large-bottom">
      ...
      <div class="x6 text-right">
        ...
        <a href="/manage/course3/create" class="button icon-file-o bg-yellow margin-right"> 新增</a>
      ...
      <div class="table-responsive padding-large-bottom articletable">
            <table class="table table-striped table-bordered">
                <tr>
                  ...
                  <td align="center" width="50">标签</td>
                  <td align="center" width="80">图片</td>
                  <td align="center" width="80">URL</td>
                  <td align="center" width="50">排序</td>
                  <td align="center" width="50">删除</td></tr>
                @if($course3->count()>0)
                @foreach ($course3 as $key=>$value)
                <tr>
                <td align="center">
                ...
                <td>
                  <input type="text" name="tag[]" value="{{$value->tag}}" class="input input-small">
                </td>
                ...
                <td>
                  <input type="text" name="url[]" class="input" value="{{$value->url}}">
                </td>
                <td>
                  <input type="number" name="index[]" class="input input-small" value="{{$value->index}}">
                </td>
                <td align="center"><a href="/manage/course3/{{ $value->id }}/delete" class="button button-little bg-main icon-trash-o" onclick="{if(confirm('删除后不可恢复：')){return true;}return false;}"> 删除</a></td>
