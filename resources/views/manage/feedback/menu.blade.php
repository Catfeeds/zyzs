...
<div class="container bg-white margin-large-top">
	<div class="padding-large">
		<form method="POST" action="/manage/feedback/menu">
        ...
        <a href="/manage/feedback/menu/insert" class="button bg-yellow icon-file-o margin-right" title=""> 新增分类</a>
		...
		<div class="x12">
            ...
            <table class="table table-striped table-bordered">
                <tr><td align="center" width="50">选择</td><td align="center">名称</td><td align="center" width="160">日期</td><td align="center" width="80">位号</td><td align="center" width="120">是否显示</td><td align="center" width="100">删除</td></tr>
                @if($menu!=="empty")
                @foreach ($menu as $mt)
                <tr>
                <td align="center">
                ...
                <td align="center"><a href="/manage/feedback/menu/remove/{{ $mt->id }}" class="button button-little bg-main icon-trash-o" onclick="{if(confirm('删除本条数据后不可恢复，请确认：')){return true;}return false;}"> 删除</a></td>
                </tr>
                @endforeach
                @else
...
{
	$('form').attr('action','/manage/feedback/menu/batchremove');
	$('form').submit();
}
