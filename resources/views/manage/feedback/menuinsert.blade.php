...
<div class="container bg-white margin-large-top">
	<div class="padding-large">
		<form method="POST" action="/manage/feedback/menu/insert">
		<div class="line-big margin-large-bottom">
			<div class="x6">
				<ul class="bread">
				    <li><a href="/manage/main" class="icon-home"> 管理后台</a> </li>
                    <li>留言管理</li>
				    <li><a href="/manage/feedback/menu" title=""> 分类管理</a></li>
            <li>新增分类</li>
				</ul>
			</div>
			<div class="x6 text-right">
				<a href="/manage/feedback/menu" class="button icon-mail-reply bg-black margin-right"> 返回</a>
			</div>
		</div>
