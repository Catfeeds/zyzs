...
<div class="container bg-white margin-large-top">
	<div class="padding-large">
		<form method="POST" action="/manage/common/insert">
		...
		<div class="x12">
          ...
          <div class="form-group padding-large-bottom">
              ...
              <div class="field">
                <textarea name="content" cols="50" class="input ckeditor" id="editor1">@if(count(old('content'))>0){!! old('content')!!}@endif</textarea>
              </div>
          ...
          <div class="form-group padding-large-bottom">
              ...
              <div class="field">
                <textarea name="reply" cols="50" class="input ckeditor" id="editor2">@if(count(old('reply'))>0){!! old('reply')!!}@endif</textarea>
              </div>
              @if($errors->has('reply'))
          ...
          <div class="form-group padding-large-bottom">
            ...
            <div class="field"><input type="text" class="input" id="keywords" name="keywords" data-validate="required:必填,keywords:错误：只能为中文、英文、数字，用英文小写逗号隔开,length#<=100:长度必须小于100个字符" placeholder="关键词1,关键词2,关键词3" value="@if(count(old('keywords'))>0){{ old('keywords') }}@endif" /></div>
          ...
          <div class="form-group padding-large-bottom">
            ...
            <div class="field"><textarea rows="5" class="input" id="description" name="description" placeholder="不超过200个字符，尽量包含关键词" data-validate="required:必填,length#<=800:长度必须小于200个字符">@if(count(old('description'))>0){{ old('description') }}@endif</textarea></div>
